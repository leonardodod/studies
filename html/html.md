...
| < input type="number" name="" min="" max="" value=""> | Define um campo numeral, que pode adicionar ou remover números.                        |
| < input type="date" name="" size="">                  | Define um campo do tipo data.                                                          |
| < list="">                                            | Tag para incluir uma lista específica (id) no campo.                                   |
| < datalist="">                                        | Cria uma lista de dados para ser usadas nas listas.                                    |
| < type="range">                                       | Define o tipo do campo para um 'slider', barra lateral interativa.                     |
| < type="color">                                       | Define o tipo do campo para um botão com cores selecionáveis.                          |
| < type="search">                                      | Arredonda as bordas do campo, normalmente usada para campos de pesquisa. (? WTF KKKKK) |
